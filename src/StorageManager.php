    ...
    protected function getUploadConfig($action)
    {
        ...
        foreach ($prefixes as $prefix) {
            if ($action == $upload[$prefix.'ActionName']) {
                $config = [
                    'action' => $upload[$prefix.'ActionName'] ?? null,
                    'field_name' => $upload[$prefix.'FieldName'] ?? null,
                    'max_size' => $upload[$prefix.'MaxSize'] ?? null,
                    'allow_files' => $upload[$prefix.'AllowFiles'] ?? [],
                    'path_format' => $upload[$prefix.'PathFormat'] ?? null,
                ];
